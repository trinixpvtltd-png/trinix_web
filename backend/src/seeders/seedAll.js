...
// Single unified seeder to create test users and ideas for local/dev testing
  ...
  try {
    ...
    const ideasToCreate = [
      ...
      },
      {
        ...
        description: 'Techniques to reduce costs in serverless architectures while maintaining performance.',
        type: 'research',
        category: 'Smart Cities',
        status: 'Prelisted'
      }
